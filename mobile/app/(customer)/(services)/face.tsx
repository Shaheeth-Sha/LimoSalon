...
const SERVICES_API = `${BASE_URL}/api/services?category=Face`;
...
export default function FaceCareServices() {
  ...
  // Stores services received from database
  ...
  /*
    Load Face Care services from MongoDB
    through backend API
  */
  const loadServices = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Error",
        "Unable to load face care services"
      );
