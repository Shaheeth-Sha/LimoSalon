...
// glyph that carries the outcome: amber "alert" for a missed
// appointment, matching the "Awaiting Completion" amber already used
      ...
      <View style={styles.content}>
        <Animated.View style={[styles.iconRing, { transform: [{ scale: iconScale }] }]}>
          <Animated.View style={{ opacity: checkOpacity }}>
            <Ionicons name="alert" size={60} color="#B9791F" />
          </Animated.View>
        </Animated.View>

        <Animated.View style={{ opacity: contentOpacity, width: '100%', alignItems: 'center' }}>
          <Text style={styles.title}>Marked as No-show</Text>
